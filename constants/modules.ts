...
export const MARKETPLACE_MODULES: ModuleDefinition[] = [
  ...
  {
    id: 'hardware-obd-pro',
    name: 'Shipstack OBD-II Ultra',
    slug: 'obd-telemetry',
    description: 'DIRECT BROKERAGE - High-frequency telemetry. Competitive bulk pricing for OBD-II vehicle diagnostics.',
    category: 'hardware',
    tier: 'starter',
    version: '2.0.0',
    versions: [],
    icon: 'Radio',
    tags: ['telemetry', 'hardware', 'brokerage'],
    publisher: { id: 'shipstack-hardware', name: 'Shipstack Brokerage', verified: true },
    pricing: { model: 'flat', amount: 12, currency: 'USD', billingPeriod: 'monthly' },
    longDescription: 'Exclusive brokerage service for enterprise-grade OBD-II devices.\nVerified hardware with pre-provisioned security certificates.\nCompetitive wholesale pricing for fleets of 10+ units.\nReal-time CAN-bus data extraction & fuel monitoring.\nFull regional support and warranty coverage.',
    dependencies: ['core-trips'],
    conflicts: [],
    permissionScope: { requiredPermissions: ['fleet:view'], grantedPermissions: ['trips:edit'] },
    routes: [],
    status: 'active',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  ...
  {
    id: 'hardware-asset-tag',
    name: 'Solar Asset Sentinel',
    slug: 'solar-tracker',
    description: 'PROMOTION - Long-life solar trackers for non-powered assets. Wholesale brokerage rates available.',
    category: 'hardware',
    tier: 'starter',
    version: '1.4.0',
    versions: [],
    icon: 'Sun',
    tags: ['solar', 'iot', 'promotion'],
    publisher: { id: 'shipstack-hardware', name: 'Shipstack Brokerage', verified: true },
    pricing: { model: 'flat', amount: 9, currency: 'USD', billingPeriod: 'monthly' },
    longDescription: 'Ruggedized solar-powered GPS trackers for trailers and containers.\nCompetitive wholesale brokerage for volume orders.\nIP67 waterproof rating with high-precision GNSS.\nSpecial promotion: 25% off for first 50 units.\nMaintenance-free 5-year operational lifecycle.',
    dependencies: ['core-fleet'],
    conflicts: [],
    permissionScope: { requiredPermissions: ['fleet:view'], grantedPermissions: ['fleet:manage'] },
    routes: [],
    status: 'active',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  ...
  {
    id: 'hardware-vision-ai',
    name: 'Cortex Vision Cam',
    slug: 'vision-telematics',
    description: 'Dual-facing AI dashcams with driver behavior scoring and incident auto-upload.',
    category: 'hardware',
    tier: 'professional',
    version: '3.0.1',
    versions: [],
    icon: 'Camera',
    tags: ['video', 'safety', 'ai'],
    publisher: { id: 'shipstack-hardware', name: 'Shipstack Brokerage', verified: true },
    pricing: { model: 'flat', amount: 45, currency: 'USD', billingPeriod: 'monthly' },
    longDescription: 'AI-powered video telematics brokerage.\nReal-time fatigue and distraction detection.\nAutomated insurance-grade incident reports.\nCloud-sync blackbox storage.\nLimited offer: Free installation for regional fleets.',
    dependencies: ['core-trips', 'addon-cortex-ai'],
    conflicts: [],
    permissionScope: { requiredPermissions: ['trips:view'], grantedPermissions: ['analytics:view'] },
    routes: [],
    status: 'active',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
