...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-brand text-white shadow-lg shadow-slate-200 hover:bg-slate-800',
    secondary: 'bg-brand-accent text-white shadow-lg shadow-blue-200 hover:bg-blue-600',
